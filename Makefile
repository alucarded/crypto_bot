SOURCES=src/collector.cc \
				src/kraken_ticker_client.hpp \
				src/mongo_ticker_consumer.hpp src/serialization_utils.hpp src/ticker_consumer.h src/ticker_client.hpp src/ticker.h src/bitstamp_ticker_client.hpp
